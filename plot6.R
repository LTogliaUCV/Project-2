...
library(ggplot2)
# Loading the data set in  the current directory 
...
#now we created the df using  the variables creates
...
png(filename='~/Users/Leonardo/Downloads/exdata%2Fdata%2FNEI_data/plot6.png')
